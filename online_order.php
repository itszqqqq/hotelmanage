        ...
        <div class="internal-page-title about-page">
            ...
            <ol class="breadcrumb">
                <li><i class="fa fa-map-marker"></i> &nbsp;<span>当前位置： <a href="index.php">网站首页</a> &gt <a
                            href="online_order.php">宾馆预订</a></span></li>
            </ol>
        </div>
                    ...
                    <div id="booking-tab-contents" class="tab-content">
                        ...
                        <div class="row">
                            <div class="date-container booking-dates col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                <h4><b>房间编号</b></h4>
                                <!-- 设置了disabled属性无法提交表单 -->
                                <input readonly type="text" value='<?php echo $_GET["orid"] ?>' id="roomid"
                                    name="roomid" class="room" />
                            </div>

                            <div class="date-container booking-dates col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                <h4><b>类型编号</b></h4>
                                <input readonly value='<?php echo $rows[1] ?>' type="text" id="typeid" name="typeid"
                                    class="room" />
                            </div>
                            <div class="date-container booking-dates col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                <h4><b>类型名称</b></h4>
                                <input readonly type="text" value='<?php echo $rows[2] ?>' name="roomtype"
                                    class="room" />
                            </div>

                            <div class="date-container booking-dates col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                <h4><b>房间价格</b></h4>
                                <input readonly id="price" type="text" value='<?php echo $rows[3] ?>元/天' name="price"
                                    class="room" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="date-container booking-dates col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                ...
                                <div class="booking-fields checkin-field">
                                    <input placeholder="选择入住日期"
                                        class="booking-date-fields-container check-in col-checkin" type="text"
                                        name="checkin" />
                            ...
                            <div class="date-container sys booking-dates col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                <img src="images/fk.png" width="120px" height="auto" alt="">
                                <p>扫&emsp;一&emsp;扫</p>
                            </div>
                        </div>
