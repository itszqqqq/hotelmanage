    ...
    <div class="main-wrap">
      <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="admin_index.php">后台管理</a><span
            class="crumb-step">&gt;</span><span class="crumb-name">退房清算</span></div>
      </div>
          ...
          <table class="result-tab" width="100%">
            ...
            if (!$s) {
              ...
              while ($rows = mysqli_fetch_assoc($rs)) { ?>
                <tr>
                  <td class='tc'>
                    <?php echo $rows["linkman"] ?>
                  </td>
                  <td class='tc'>
                    <?php echo $rows["cardid"] ?>
                  </td>
                  <td class='tc'>
                    <?php echo $rows["phone"] ?>
                  </td>
                  <td class='tc'>
                    <?php echo $rows["messages"] ?>
                  </td>
                </tr>
              <?php } ?>
            <?php } ?>
            ...
            if (!$s) {
              ...
              while ($rows = mysqli_fetch_assoc($rs)) {
                ...
                <tr>
                  ...
                  <td class='tc'>
                    <?php echo $rows["monetary"] ?>
                  </td>
                  <td class='tc'>
                    <?php echo $rows["ostatus"] ?>
                  </td>
                  <td class='tc'>
                    <?php echo $rows["oremarks"] ?>
                  </td>
