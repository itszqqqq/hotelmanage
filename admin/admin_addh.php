        ...
        <div class="main-wrap">
            <div class="crumb-wrap">
                <div class="crumb-list"><i class="icon-font"></i><a href="admin_index.php">后台管理</a><span
                        class="crumb-step">&gt;</span><span class="crumb-name">新增房间</span></div>
            </div>
          ...
          ?>
                    <ul class='order'>
                        <li>
                            ...
                            <input name="roomid" placeholder="房间编号" type="text" required id="roomid" size="10"
                                maxlength="50" />
                        </li>
                        <li>
                ...
                ?>
                        ...
                        <li>
                            ...
                            <input name="file" type="file" id="file" accept="image/*" /><span
                                class="xxx"></span>图片预览&emsp;<img height="auto" width="120px" id='imgs'>
                        </li>
                        <script>
                        $(function() {
