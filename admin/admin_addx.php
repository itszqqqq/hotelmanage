    ...
    ?>
        ...
        <div class="main-wrap">
            <div class="crumb-wrap">
                <div class="crumb-list"><i class="icon-font"></i><a href="admin_index.php">后台管理</a><span
                        class="crumb-step">&gt;</span><span class="crumb-name">新增相册</span></div>
            </div>
            ...
            ?>
                        <li>
                            ...
                            <input required placeholder="相册标题" name="title" type="text" id="title" size="30"
                                maxlength="50" />
                        </li>
                        <li>
                            <label for="">相册小图&emsp;</label>
                            <label for="file" class='fjtp'>上传图片</label>
                            <input name="file" type="file" id="file" accept="image/*" /><span
                                class="xxx"></span>图片预览&emsp;<img height="auto" width="60px" id='img'>
                        </li>
                        <li>
                            <label for="">相册大图&emsp;</label>
                            <label for="files" class='fjtp'>上传图片</label>
                            <input name="files" type="file" id="files" accept="image/*" /><span
                                class="xxxx"></span>图片预览&emsp;<img height="auto" width="60px" id='imgs'>
                        </li>
                        <script>
                        $(function() {
